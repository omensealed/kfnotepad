...
#[path = "text_buffer/history_queue.rs"]
mod history_queue;
...
use history_queue::buffer_bytes;
pub(crate) use history_queue::{pop_history_entry, push_history_entry};
...
pub(crate) use types::{EditDelta, EditGroup, HistoryEntry};
